...
//
//   Interactive:   node tools/hash-password.mjs approved-admin@bhwmedical.org "Approved Admin" admin
//                  Password: ••••••  (type it, press enter)
//
//   Piped:         printf '%s' 'the-password' | node tools/hash-password.mjs approved-admin@bhwmedical.org "Approved Admin" admin
//
